...
public class LoginFrame extends JFrame {
	...
	/**Cambia el look and feel del programa.
	 * @param props Propiedades del nuevo look and feel.
	 * @throws InstantiationException Si no se puede instanciar el L&F.
	 * @throws IllegalAccessException Si la clase del L&F o su inicializador no están accesibles.
	 * @throws ClassNotFoundException Si no se encuentran las clases del L&F.
	 * @throws UnsupportedLookAndFeelException Si el SO no soporta este L&F.
	 */
	private static void cambiarLookAndFeel(Properties props)
		...
		btnAcceso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (textFieldNombre.getText().isEmpty()
					...
					if (u != null) { //Si he encontrado al usuario						
