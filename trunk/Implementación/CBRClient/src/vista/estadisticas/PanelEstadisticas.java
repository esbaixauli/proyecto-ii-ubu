...
public class PanelEstadisticas extends JPanel {
	...
	public PanelEstadisticas(EnumEstadisticas tipo, Usuario usuario) {
		...
		springLayout.putConstraint(SpringLayout.NORTH, panel_listas, 0,
				SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, panel_listas, 0,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.SOUTH, panel_listas, 379,
				SpringLayout.NORTH, this);
		...
		springLayout.putConstraint(SpringLayout.NORTH, panelEstInterno, 0,
				SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, panelEstInterno, 350,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.SOUTH, panelEstInterno, 379,
				SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.EAST, panelEstInterno, -10,
		...
		panelGraf.setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec
				.decode("334px"), }, new RowSpec[] { RowSpec.decode("53px"),
				RowSpec.decode("212px"), FormFactory.RELATED_GAP_ROWSPEC,
				FormFactory.DEFAULT_ROWSPEC, }));

		JPanel panelRelleno = new JPanel();
		panelGraf.add(panelRelleno, "1, 1, fill, fill");

		tabbedPaneGraficos = new JTabbedPane(JTabbedPane.TOP);
		panelGraf.add(tabbedPaneGraficos, "1, 2, fill, fill");
		...
		panelEstInterno.add(panelInforme, BorderLayout.WEST);
